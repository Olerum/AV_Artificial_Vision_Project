...
class Objeto2D(object):
    ...
    def __init__(self, tipo='circulo', pos=(0,0), pos_rand=(0,0), rot=(0,0), size=70, scala_rand=(1.0,1.0), color=(175,0,0), sigma=10, clase=0):
        self.tipo       = tipo
...
class VideoVirtual(object):
    ...
    ##########################################################################################
    # Método constructor que se ejecuta durante la instanciación de un objeto
    def __init__(self, tipo = 'circulo', camera = Camera(), escena = Escena(), max_iter=14):
        self.tipo     = tipo
        self.iter     = 0
        ...
        if tipo == 'circulo':
            ...
            circulo = Objeto2D(tipo='circulo', pos=centro, pos_rand=(10,10), size=radio, color=(200,0,0), sigma=10)
        ...
        if tipo == 'colores':
            ...
            colores = ((215,40,40),(40,215,40),(40,40,215),(215,215,40),(215,40,215),(40,215,215),(40,40,40),(215,215,215))
            num_rectangulos = len(colores)
            ...
            for k, bgr in enumerate(colores):
        ...
        if tipo == 'figuras':
            ...
            radio = int(np.sqrt( self.camera.num_pixels/(scale*np.pi) ) ) 
            centro = (int(self.camera.img_size[1]/2), int(self.camera.img_size[0]/2) )
            circulo = Objeto2D(tipo='circulo', pos=centro, pos_rand=(10,10), size=radio, scala_rand=(0.8,1.2), color=(0,0,255), sigma=10)
            self.escena.add(circulo)
    ...
    def release(self):
        print('Número de imágenes generadas', self.iter)
